...
export async function apiServer(config: AxiosRequestConfig) {
...
export async function apiGet<T = any>(url: string, config: AxiosRequestConfig = {}) {
  return apiServer({ ...config, method: "get", url }) as Promise<AxiosResponse<T>>;
}

export async function apiPost<T = any>(url: string, data?: any, config: AxiosRequestConfig = {}) {
  return apiServer({ ...config, method: "post", url, data }) as Promise<AxiosResponse<T>>;
}

export async function apiPut<T = any>(url: string, data?: any, config: AxiosRequestConfig = {}) {
  return apiServer({ ...config, method: "put", url, data }) as Promise<AxiosResponse<T>>;
}

export async function apiDelete<T = any>(url: string, config: AxiosRequestConfig = {}) {
  return apiServer({ ...config, method: "delete", url }) as Promise<AxiosResponse<T>>;
}