          ...
          {topBranches.map((branch, index) => (
            <tr key={index} className={`${index % 2 === 0 ? 'bg-white' : 'bg-gray-50'}`}>
              ...
              <td className="px-4 py-3 text-center">
                <span className="bg-green-100 text-green-700 px-12 py-2 rounded-full">{branch.served}</span>
              </td>
              <td className="px-4 py-3 text-center">
                <span className="bg-red-100 text-red-700 px-12 py-2 rounded-full">{branch.notServed}</span>
              </td>
              <td className="px-4 py-3 text-center">
                <span className="bg-yellow-100 text-yellow-700 px-12 py-2 rounded-full">{branch.waiting}</span>
              </td>
              <td className="px-4 py-3 text-center">
                <span className="bg-blue-100 text-blue-700 px-12 py-2 rounded-full">{branch.inService}</span>
              </td>
            </tr>
          ))}
        </tbody>
