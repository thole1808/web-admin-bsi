...
const CabangIcon: React.FC<IconProps> = ({
    width = 24,
    height = 24,
    color = "#007C80",
}) => {
    return (
        <svg width="24" height="20" viewBox="0 0 24 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
              d="M17 19V17C17 15.9391 16.5786 14.9217 15.8284 14.1716C15.0783 13.4214 14.0609 13 13 13L5 13C3.93913 13 2.92172 13.4214 2.17157 14.1716C1.42143 14.9217 1 15.9391 1 17L1 19"
              stroke="#007C80"
              strokeWidth="2"
              strokeLinecap="round"
