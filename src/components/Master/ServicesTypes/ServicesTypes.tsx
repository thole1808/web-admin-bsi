...
//                             <h2 className="text-xl font-semibold">Edit Service Type</h2>
//                             <div className="my-2">
//                                 <input
//                                     type="text"
...
//                                 <input
//                                     type="text"
//                                     value={currentItem.name}  {/* Akses langsung ke name jika currentItem tidak null */}
//                                     onChange={(e) => {
//                                         setCurrentItem({
//                                             ...currentItem,
//                                             name: e.target.value,
//                                             id: currentItem.id,  // Pastikan id tetap ada dan tidak berubah
//                                         });
//                                     }}
//                                     className="border border-gray-300 rounded px-3 py-2 w-full"
//                                 />
...
//                                 </button>
//                                 <button
//                                     onClick={() => handleEdit(currentItem.id)}
//                                     className="bg-blue-500 text-white px-6 py-2 rounded-md"
//                                 >
//                                     Update
//                                 </button>
