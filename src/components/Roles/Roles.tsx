...
const Roles: React.FC = () => {
    ...
    //                 <button
    //                     onClick={() => fetchRoleDetail(row.id)}
    //                     className="text-blue-500 hover:text-blue-700 flex items-center space-x-1 text-xs sm:text-sm"
    //                 >
    //                     <EyeIcon className="h-5 w-5" />
    //                     <span>Detail</span>
    //                 </button>
    ...
    //                         setIsModalOpen(true);
    //                     }}
    //                     className="text-green-500 hover:text-green-700 flex items-center space-x-1 text-xs sm:text-sm"
    //                 >
    //                     <PencilIcon className="h-5 w-5" />
    //                     <span>Edit</span>
    //                 </button>
    //                 <button
    //                     onClick={() => handleDelete(row.id)}
    //                     className="text-red-500 hover:text-red-700 flex items-center space-x-1 text-xs sm:text-sm"
    //                 >
    //                     <TrashIcon className="h-5 w-5" />
    //                     <span>Delete</span>
    //                 </button>
                ...
                <div>
                    {detailData ? (
                        <div>
                            ...
                            <p><strong>Guard Name:</strong> {detailData.guardName}</p>
